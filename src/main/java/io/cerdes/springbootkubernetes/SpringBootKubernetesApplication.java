...
@KubernetesApplication(ingress = @Ingress(expose = true, host = "spring-boot-kubernetes.io"), serviceType = ServiceType.NodePort, replicas = 2, ports = @Port(name = "web", containerPort = 8080, protocol = Protocol.HTTP))
